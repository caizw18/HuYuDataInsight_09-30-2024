...
# Print the results
print(f"Lyft Inc. (LYFT) Current Stock Price: {S:.2f}")
...
# Lyft Inc. (LYFT) Current Stock Price: 10.75
# Strike Price: 12
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.50
# Call Option Price: 1.34
# Put Option Price: 2.56